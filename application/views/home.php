    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                    <?php if(! is_null($successmsg)) echo $successmsg;?>
                    <?php if(! is_null($msg)) echo $msg;?>
                            ...
                            <div class="col-md-4">
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget slimscroll-alt" style="min-height: 302px;">
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/images/users/avatar-6.jpg" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/images/users/avatar-8.jpg" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/images/users/avatar-9.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table table-hover m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-6.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-7.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="<?php echo base_url();?>assets/images/users/avatar-8.jpg" alt="user" class="thumb-sm img-circle" />
                                                    </th>
                                                    <td>
                        ...
                        <!-- end row -->
                        <a type="button" href="<?php echo base_url();?>Add" class="btn btn-purple btn-rounded w-md waves-effect waves-light m-b-5">Add Form</a>
                        <a type="button" href="<?php echo base_url();?>Show"class="btn btn-purple btn-rounded w-md waves-effect waves-light m-b-5">Show Form</a>
        ...
        <!-- Flot chart js -->
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.min.js"></script>
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.time.js"></script>
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.tooltip.min.js"></script>
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.resize.js"></script>
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.pie.js"></script>
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.selection.js"></script>
        <script src="<?php echo base_url();?>../plugins/flot-chart/jquery.flot.crosshair.js"></script>
        ...
        <!-- Dashboard init -->
        <script src="<?php echo base_url();?>assets/pages/jquery.dashboard_2.js"></script>
